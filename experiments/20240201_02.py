...
MEMO = "Cityの特徴量重要度が高かったため，削除してみる"
...
class Params:
    ...
    drop_cols = ["City"]
    categorical_features = ["FranchiseCode", "RevLineCr", "LowDoc", "UrbanRural", "State", "BankState", "Sector"]
    encoding_target_cols = ["FranchiseCode", "RevLineCr", "LowDoc", "UrbanRural", "State", "BankState", "Sector"]
